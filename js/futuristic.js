                ...
                custom: function({ series, seriesIndex, dataPointIndex, w }) {
                    ...
                    return `
                        <div style="padding: 10px; width: 300px; white-space: normal; overflow-wrap: break-word; word-break: break-word;">
                            ...
                            <span style="color: #ccc;">Жами ҳолатлар:</span> 
                            <span style="color: #0ff;">${value} ta</span>
                        </div>
                        `;
                }
            },
...
const container = document.getElementById("crimeLocationList");
...
function init() {
    var map = new ymaps.Map("crimeLocationMap", {
